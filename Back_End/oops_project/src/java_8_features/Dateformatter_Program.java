...
//    convert string into LocalDateTime       
      String dateTimeFormat="20-06-25 18:02:57";
      LocalDateTime parse=LocalDateTime.parse(dateTimeFormat,java.time.format.DateTimeFormatter.ofPattern("dd-MM-YYYY HH:mm:ss"));
